<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"G:\PHP\WWW\kefuxitong\public/../application/admin\view\users\edituser.html";i:1525743514;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t layui-form" id="commentForm" method="post" action="<?php echo url('users/edituser'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="group_id" name="group_id" value="<?php echo $info['group_id']; ?>"/>
                            <div class="input-group col-sm-4 layui-form">
                                <select lay-verify="required" lay-filter="group">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $info['group_id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
