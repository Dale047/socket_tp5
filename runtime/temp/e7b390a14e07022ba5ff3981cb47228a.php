<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"G:\PHP\WWW\kefuxitong\public/../application/admin\view\system\wordslog.html";i:1525743514;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    function initTable() {
        ...
        $("#cusTable").bootstrapTable({
            ...
            url: "<?php echo url('system/wordsLog'); ?>", //获取数据的地址
            striped: true,  //表格显示条纹
